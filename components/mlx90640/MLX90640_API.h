...
typedef struct
    ...
    /**
     * @brief Calculate temperatures with support for both float and fixed-point outputs
     * 
     * @param frameData Raw frame data from sensor
     * @param params Calibration parameters
     * @param emissivity Surface emissivity (0-1)
     * @param tr Reflected temperature
     * @param result Float array to store results (768 elements)
     * @param result_fixed Optional fixed-point array to store results (768 elements)
     * 
     * If result_fixed is provided, fixed-point calculations will be used for better performance,
     * and both arrays will be populated.
     */
